...
class Alumno{
    ...
    public function materiasAsignadas($maestro){
        ...
        for($i = 0; $i < $cuantos; $i++){
            ...
            echo"<tr>";
            echo"<td>$materia</td><td><a href='eliminar.php?id=$id_mat&id_m=$maestro'>Eliminar</a></td>";
            echo"</tr>";
        }
        echo"</div>";
    }
    ...
    public function muestraMaterias($maestro){
        ?>
            <div class="col-sm-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Materias</h3>
                    </div>
